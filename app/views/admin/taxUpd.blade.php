...
@endif
{{ Form::open(array('url' => 'employees/tax/update/' . $tax->tax_id)) }}
<div class="row centered-form">
    <div class="col-xs-12 col-sm-12 col-md-6 col-lg-6 col-xs-offset-0 col-sm-offset-0 col-md-offset-3 col-lg-offset-3 toppad">
        <div class="panel panel-default panel-danger">
            <div class="panel-heading ">
                <h3 class="panel-title">{{trans('labels.taxUpd.lbl_title')}}</h3>
            </div>
            <div class="panel-body">
                <div class="form-group @if ($errors->has('status')) has-error @endif">
                    <label for="old password">{{trans('labels.tax.lbl_status')}}</label>
                    <input type="text" id="status" class="form-control" name="status" placeholder="Enter Status" value="{{ $tax->status }}">
            ...
            <div class="form-group @if ($errors->has('basis')) has-error @endif">
                ...
                <input type="basis" id="basis" class="form-control" name="basis" placeholder="Enter Income Amount" value="{{ $tax->basis}}">
        ...
        <div class="form-group @if ($errors->has('excess')) has-error @endif">
            <label for="excess">{{trans('labels.tax.lbl_diff')}}</label>
            <input type="text" id="excess" class="form-control" name="excess" placeholder="Enter added difference" value="{{ $tax->excess}}">
    ...
    <div class="form-group @if ($errors->has('excemption')) has-error @endif">
        ...
        <input type="text" id="excemption" class="form-control" name="excemption" placeholder="Enter tax" value="{{ $tax->excemption}}">
